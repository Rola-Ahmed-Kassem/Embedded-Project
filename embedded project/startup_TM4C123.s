...
Reset_Handler   PROC
                ...
                IMPORT  __main
                ; Enable FPU
                LDR     R0, =0xE000ED88          ; Load the address of SCB_CPACR
                LDR     R1, [R0]                 ; Load the current value of SCB_CPACR
                ORR     R1, R1, #0x00F00000     ; Set bits 20-22 to enable FPU (full access)
                STR     R1, [R0]                 ; Store the updated value back to SCB_CPACR
               DSB
              ISB
                LDR     R0, =__main
                BX      R0
